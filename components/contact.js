    ...
    <section id="contact" class="py-16 md:py-24 bg-gray-100">
      <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid md:grid-cols-2 gap-12 md:gap-16">
          ...
          <!-- LEFT SIDE: FORM -->
          <div>
            <h2 class="text-3xl md:text-4xl font-bold mt-12 md:mt-20 mb-4">
              Let’s talk about your goals.
            </h2>

            <p class="text-gray-600 mb-8 md:mb-10 leading-relaxed">
          ...
          <div>
            ...
            <!-- MAP -->
            <div class="rounded-xl overflow-hidden shadow-lg mb-8 aspect-video">
              <iframe
                class="w-full h-full"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3873.306924673067!2d121.10566829999999!3d13.880587199999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33bd124224c8a75f%3A0x578be4e80b3b3fee!2sInfinity%20Web%20Solutions!5e0!3m2!1sen!2sph!4v1771384878144!5m2!1sen!2sph"
                loading="lazy"
                allowfullscreen>
              </iframe>
            </div>
